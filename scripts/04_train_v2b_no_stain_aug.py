...
# ===================================================================
V2_PHASE = "A"
V2_TAG = "v2.0b-phaseA-noStainAug"
...
def _log_preamble(cfg: dict, cfg_hash: str) -> None:
    ...
    logger.info("Stain augment     : DISABLED (v2.0b ablation)")
    cfg["training"]["experiment_name"] = "brightfield_cells_nuclei_noStainAug"
...
def main() -> None:
    ...
    logger.info("[v2.0b] Stain augmentation DISABLED for ablation study")
